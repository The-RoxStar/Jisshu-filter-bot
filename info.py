...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002190654024'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/JisshuMovieZone')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002398327118 -1001934525883 -1002233647976 -1002191291739 -1002152906241 -1002152906241 -1002181251938 -1002248009127').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ROXIE:ROXIE@cluster0.dyh6q.mongodb.net/?retryWrites=true&w=majority")
...
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002301231547')) # The movie you upload in it will be deleted from the bot.
...
#---------------------------------------------------------------
TUTORIAL = environ.get("TUTORIAL", "https://t.me/ipapcorn_update/59")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/ipapcorn_update/59")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/ipapcorn_update/59")
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://iili.io/2F9eh4j.md.jpg')).split()
